# -*- coding: utf-8 -*-
"""
Created on Mon Feb 11 04:09:55 2019
...
random_classifier = RandomForestClassifier(n_estimators=100, 
                                           random_state=1)
random_classifier.fit(X_train,y_train_1)
predict_randomforest = random_classifier.predict(X_test)

from sklearn.metrics import confusion_matrix

confusion_matrix(y_test_1, predict_randomforest)

from sklearn.metrics import precision_score
precision_score(y_test_1, predict_randomforest)
